...
import { editProduct, selectProduct } from "../../productSlice.js";
...
export default function EditProduct() {
  ...
  const [product, setProduct] = useState({
    ...
    productFreshness: initialProduct.productFreshness || "",
    textDescription: initialProduct.textDescription || "",
    priceProduct: initialProduct.priceProduct || "",
  });
      ...
      <form onSubmit={eventHandlerSubmit}>
        <div className="content">
          <div className="form-detail-product">
            ...
            <div className="select-category">
              ...
              >
                {optionsCategory.map((option) => {
                  return (
                    <option key={option.value} value={option.value} selected={product.productCategory === option.value}>
                      {option.label}
                    </option>
                  );
                })}
            ...
            <Link to={`/createProduct`} className="btn" type="button" style={{marginTop: "5px"}}>
              Back
            </Link>
          </div>
        </div>
